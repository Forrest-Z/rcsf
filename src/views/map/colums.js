...
// ** Store & Actions
import { deleteMap, updateMap } from './store/actions'
          ...
          <UncontrolledDropdown>
            ...
            <DropdownMenu right>
              ...
              <DropdownItem
                ...
                onClick={(e) => {
                  e.preventDefault()
                  store.dispatch(updateMap(row.id, {active: !row.active}))
                }}
              >
                {row.active ? (
                  <div>
