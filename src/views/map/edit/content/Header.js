  ...
  return (
    <UncontrolledButtonDropdown className='h-100'>
      ...
      >
        <Circle
          className={
            `${type === 'Charge Point' && 'text-info'} 
             ${type === 'Park Point' && 'text-primary'}
             ${type === 'Route Point' && 'text-success'}`
          }
          size={23}
        />
        <small className='font-weight-bold' style={{ paddingTop: '5px' }}>{type}</small>
      </Button>
      <DropdownToggle className='dropdown-toggle-split pl-0' outline color='flat-dark' caret></DropdownToggle>
      <DropdownMenu tag='ul'>
        <DropdownItem
      ...
      <div className='d-flex align-items-center w-100 p-0'>
        ...
        <Row className='w-100 h-100'>
          <Col xl='1'>
            ...
            >
              <Save size={23} />
              <small className='font-weight-bold' style={{ paddingTop: '5px' }}>Save</small>
            </Button>
          </Col>
          ...
          <Col xl='1'>
            ...
            >
              ...
              <small className='font-weight-bold' style={{ paddingTop: '5px' }}>Mouse</small>
            </Button>
          </Col>
          ...
          <Col xl='1'>
            ...
            >
              ...
              <small className='font-weight-bold' style={{ paddingTop: '5px' }}>Area</small>
            </Button>
          </Col>
          ...
          <Col xl='1'>
            ...
            >
              ...
              <small className='font-weight-bold' style={{ paddingTop: '5px' }}>Block</small>
            </Button>
          </Col>
          ...
          <Col xl='1'>
            <Button
              ...
              <small className='font-weight-bold' style={{ paddingTop: '5px' }}>Group</small>
            </Button>
          </Col>
        </Row>
      </div>
