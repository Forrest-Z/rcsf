    ...
    <div className="p-1">
      <Row>
        ...
        <Col xl="8">
          <Input
            bsSize="sm"
            value={StageMobx.selection.id}
            onChange={() => StageMobx.selection.setID(StageMobx.selection.id)}
          />
        </Col>
      </Row>
      <hr />
      <Row>
        ...
        <Col xl="4" className="pl-0">
          <InputGroup size="sm">
            ...
            <Input
              value={StageMobx.selection.y}
              onChange={() => StageMobx.selection.setY(StageMobx.selection.y)}
            />
          </InputGroup>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col xl="8">
          <Input
            ...
            bsSize="sm"
            id="select-sm"
            value={StageMobx.selection.type}
            onChange={e => StageMobx.selection.setType(e.target.value)}
          >
            <option>Route</option>
